...
H_SHELL=$(cat "$ROOT/web/index.html" "$ROOT/web/deeplink.js" "$ROOT/web/yfs.js" "$ROOT/web/settings.js" "$ROOT/web/studio-flight.js" "$ROOT/web/studio-settings.js" "$ROOT/web/packs.js" "$ROOT/web/packs-ui.js" \
...
cp "$ROOT/web/packs.js" "$ROOT/web/packs-ui.js" "$ROOT/web/pack-net.js" "$ROOT/web/pack-update.js" "$ROOT/web/opfs-store.js" "$ROOT/web/memfs-lru.js" "$ROOT/web/replays-ui.js" "$ROOT/web/workbench.js" "$ROOT/web/staging.js" "$ROOT/web/diag.js" "$ROOT/web/deeplink.js" "$ROOT/web/yfs.js" "$ROOT/web/settings.js" "$DIST_DIR/"
