...
const S = ({
  ja: {
    ...
    blSampleTitle: 'Boeing公式三面図から起こした8,432三角形の完成機（舵面・脚が可動、曲面はスムーズシェーディング）。そのまま上のドロップ欄に入れても、Blenderの参考にしてもOK',
  ...
  en: {
    ...
    blSampleTitle: 'A finished 8,432-triangle airliner compiled from the official Boeing three-view (movable control surfaces and gear, smooth-shaded curves). Drop it into the file drop as-is, or use it as a Blender reference',
